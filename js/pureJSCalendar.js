...
var pureJSCalendar = (function () {
    ...
    window.addEventListener('click', function(e){
        if (document.getElementById('cal') && document.getElementById('cal').contains(e.target) || document.getElementById('txtTest').contains(e.target)){
        } else{
            close();
        }
    });
    ...
    function updateDate(mont) {
        ...
        try {
            tDay += document.getElementById(eFormCalendarElement).value[0];
            tDay += document.getElementById(eFormCalendarElement).value[1];
    
            tMonth += document.getElementById(eFormCalendarElement).value[3];
            tMonth += document.getElementById(eFormCalendarElement).value[4];
    ...
    const dayClick = function (element) {
        ...
        /*
        for(var i = 0; i < document.getElementsByClassName('eformDay').length; i++) {
            if(document.getElementsByClassName('eformDay')[i].classList.contains('chosen-date')) {
                document.getElementsByClassName('eformDay')[i].classList.remove('chosen-date');
            }
        }
        */

        //element.classList.add('chosen-date');
        //alert(dateResult);
